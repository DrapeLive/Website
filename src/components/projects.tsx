    ...
    const projects = [
        {
            title: "BlastOff",
            description:
                "Casual infinite runner with vector graphics — dodge obstacles, collect stars, customize your rocket, and survive for high scores.",
            href: "/projects/blastoff",
            banner: "/projects/blastoff/blastoff-banner.png",
            tag: "Game",
        },
        {
            title: "StockFlow",
        ...
        },
{
        ...
        },
        {
            title: "Paisa Book",
            description:
                "Simple money management and expense tracking app — record income and expenses, organise spending by categories, set budgets, and see where your money goes.",
            href: "/projects/paisabook",
            banner: "/projects/paisabook/banner.png",
            tag: "App",
        },
    ];
